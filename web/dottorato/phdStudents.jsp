...
<html lang="en">
    ...
    <body class="page-body">
        ...
        <div class="page-container">
            ...
            <% ArrayList<Person> students = PhdPeopleManager.getInstance().getPhdStudents();
                PhdClass aClass = null;
                Person aTutor = null;
            %>
                                ...
                                <table data-toggle="table" class="table table-hover" align="center" data-pagination="true" data-search="true">
                                    <thead> 
                                        <tr id="null">
                                            ...
                                            <th data-field="tutor" data-sortable="true">Tutor</th>
                                        </tr> 
                                    </thead>

                                    <% for (Person student : students) {%>
                                    <tr id="<%= student.getSsn()%>" class="pointer">
                                        <td><%= student.getName()%></td>
                                        <td><%= student.getSurname()%></td>	

                                        <% aClass = PhdClassManager.getInstance().getPhdClassBySSN(student.getSsn());%>

                                        <td><%= aClass.getFK_PhdCycle()%></td>
                                        <td><%= aClass.getFK_PhdCurriculum()%></td>

                                        <% aTutor = PhdPeopleManager.getInstance().getTutor(student.getSsn());
                                            if (aTutor != null) {%>

                                        <td><%= aTutor.getName()%> <%= aTutor.getSurname()%></td>
                                        <% }%>
                                    </tr>
                                    <% }%>
                                </table>

                                <form id="studentForm" action = "studentProfile.jsp" method = "POST" target = "_blank" >
                                <input type = "hidden" id="studentSsn" name="studentSsn" value="" />
                                </form>
